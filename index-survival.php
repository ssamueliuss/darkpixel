...
<div style="text-align: center; margin: 20px 0; color: white;">
    <h1 style="font-size: 32px; font-family: 'Press Start 2P', cursive;">Supervivencia</h1>
    <p style="font-size: 16px; max-width: 600px; margin: 10px auto;">
        Explora nuestra colección de juegos de supervivencia, ¿Te crees capaz de mantenerte vivo en estos mundos abandonados y bizarros?. 
        Pelea, escapa, o muere; tú decides cual es tu destino.
    </p>
</div>
        ...
        <div class="col-md-4">
            <div class="card bg-dark text-white">
                ...
                <div class="card-body">
                    ...
                    <a href="genres/survival/game-fearandhunger.php" class="btn btn-primary">Ver más</a>
                </div>
            </div>
        </div>
        <!-- Card 2 -->
        ...
        <div class="col-md-4">
            <div class="card bg-dark text-white">
                ...
                <div class="card-body">
                    ...
                    <a href="form-game3.php" class="btn btn-primary">Ver más</a>
                </div>
            </div>
        </div>
    </div>
